...
public class DuelistGenerator : MonoBehaviour
{
    ...
    public DuelistController GenerateDuelist()
    {
        ...
        Sprite randomAccessory = _accessories[Random.Range(0, _accessories.Length)];
        ...
        duelistAnimation.SetVisualFeatures(randomEyes, randomNose, randomMouth, randomBody, randomAccessory);
